#!/usr/bin/env python3
"""
create-feature.py - Create a new feature branch and spec structure

Usage:
  python3 create-feature.py --number 5 --short-name "user-auth" "Add user authentication"
  python3 create-feature.py --json --number 5 --short-name "user-auth" "Add user authentication"
...
"""
        ...
        checklist_template = templates_dir / "checklist-template.md"
...
def main():
    parser = argparse.ArgumentParser(
        description="Create a new feature branch and spec structure",
...
Examples:
  ...
  python3 create-feature.py --json --number 5 --short-name "user-auth" "Add user authentication"
    ...
    # Create the feature
    result = creator.create_feature(args.number, args.short_name, description)
    ...
    if args.json:
        ...
        print("")
        creator.print_success("Feature created successfully!")
        print("")
